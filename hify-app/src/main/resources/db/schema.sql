...
CREATE TABLE IF NOT EXISTS hify_chat_message (
    ...
    finish_reason   VARCHAR(32)  DEFAULT NULL COMMENT '停止原因: stop / length / error / tool_calls / content_filter',
    latency_ms      INT          DEFAULT NULL COMMENT '响应耗时（毫秒），仅 assistant 消息',
